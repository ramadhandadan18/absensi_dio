                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example" width="100%" id="main-table">
                            <thead>
                                <tr>
                                    ...
                                    <th width="20%">Tanggal Tukar</th>
                                    <th width="20%">Pemohon</th>
                                    <th width="20%">Rekan Pengganti</th>
                                    <th width="20%">Jam Pengganti</th>
                                    <th width="20%">No Telp Pemohon</th>
                                    <th width="20%">No Telp Pengganti</th>
...
<script>
    ...
    function getMainTable() {
        ...
        var oTable = $('#main-table').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "<?= base_url('Jadwal/get_data/') ?>" + fill_tanggal,
                type: 'GET',
